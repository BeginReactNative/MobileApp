...
export default class SwiperAnimated extends PureComponent {
    static propTypes = {
     ...
     //   onLeftSwipe: PropTypes.func,
        ...
        // Add border paginationActiveDotBorder
        paginationActiveDotBorder:PropTypes.string,
        //
    ...
    renderPagination = () => {
        ...
        const { paginationDotColor, paginationActiveDotColor, paginationActiveDotBorder,
